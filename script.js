...
const partOfspeechE1 = document.getElementById("partOfspeech");
const exampleE1 = document.getElementById("example");
...
async function fetchAPI(word){
    ...
    partOfspeechE1.innerText = "N/A";
    exampleE1.innerText = "N/A";
    } else {
    infoTextE1.style.display = "none";
    meaningContainerE1.style.display = "block";
    ...
    synonymE1.innerText = result[0].meanings[0].definitions[0].synonyms;
    partOfspeechE1.innerText = result[0].meanings[0].partOfSpeech;
    exampleE1.innerText = result[0].meanings[0].definitions[0].example;
    }

    } catch (error) {
        console.log(error);
        infoTextE1.innerText = `An error has occured`;
    }
